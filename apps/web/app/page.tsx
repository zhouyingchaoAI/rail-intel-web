  ...
  return (
    <div className="space-y-8">
      ...
      <section className="grid gap-6 lg:grid-cols-4">
        <MetricCard label="Network Health" value={`${dashboard.network_health}%`} delta="+1.6% vs last month" />
        <MetricCard label="Reliability Index" value={`${dashboard.reliability_index}%`} delta="Stable" />
        <MetricCard label="Risk Index" value={`${dashboard.risk_index}`} delta="-2.4 trend" />
        <MetricCard label="Active Alerts" value={`${dashboard.active_alerts}`} delta="3 critical" />
      </section>
